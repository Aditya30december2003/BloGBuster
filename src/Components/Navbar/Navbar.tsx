...
const Navbar = () => {
  ...
  return (
    ...
    <div className={nav ?'text-center w-full h-full absolute top-0 left-0 bg-white font-bold duration-700 text-black' : 'text-center bg-white text-black w-full h-full absolute top-[-100%] left-0  font-bold duration-700'}>
