...
const Navbar = () => {
  ...
  return (
    ...
    <div className={nav ?'text-center w-full h-full absolute top-0 left-0 bg-white font-bold duration-700 text-black' : 'text-center opacity-0 bg-white text-black w-full h-full absolute left-[-100%]   font-bold duration-700'}>
